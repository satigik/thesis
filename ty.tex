\newpage
\pagestyle{empty}
% {\centering{\textbf{\large Acknowledgments}}
% \chapter*{Acknowledgements}
\begin{center}
  \textbf{\large Acknowledgments}
% {\centering{\chapter*{Acknowledgments}}}
\end{center}
% \begin{quote}
...
insightful advice. % \emph{Professor, I am grateful for all these years of
  % learning and fruitful work that culminated in this doctoral thesis.}
...
% \emph{Peter, thank you very much for
% all the encouragement you gave me. It meant a lot to me.}
I also want to
...
% \emph{Dr.~Viñas, thank you very much for your time, availability, and guidance.}
As special
