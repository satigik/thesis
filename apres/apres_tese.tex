...
\begin{frame}
 ...
 % \framesubtitle{Escalas de tempo}
  \begin{itemize}
...
\begin{frame}\frametitle{Premissas básicas adotadas neste trabalho} \label{common}
  ...
  \item Estamos interessados em descrever \alert{oscilações eletrostáticas} de
    ...
    \end{itemize}
  % \item Características do plasma e das oscilações que vamos estudar: 
  %   \begin{itemize}
  %   \item Plasma de hidrogênio totalmente ionizado: $n_e=n_i=n$;
  %   \item Homogêneo;
  %   \item Não magnetizado ${\bf B=0}$;
  %   \item Oscilações eletrostáticas de baixa amplitude.
  %   \end{itemize}
%    \vspace{0.2cm}
    \pause
...
\item Sendo:
  ...
  \end{itemize}
  % $\sum_a \chi_a({\bf k},\omega)$ a susceptibilidade dielétrica
...
%     % \pause
%     % \vspace{-0.3cm}
%     % \item Que é válida apenas para ondas $L$.
%   \end{itemize}
% \end{frame}

% \begin{frame}
%   \frametitle{\emph{Bremsstrahlung} eletrostático para ondas $(L)$ e $(S)$}
%   \begin{itemize}
%   \item A expressão para o \emph{bremsstrahlung} eletrostático
%     das ondas $L$
%   \end{itemize}
%    \vspace{0.1cm}
%     \begin{equation*}
...
%     de \emph{bremsstrahlung} eletrostático é dado por
%   \end{itemize}
%    \vspace{0.1cm}
%   \begin{equation*}
%     \label{PkS}
...
\begin{frame}
  ...
  \begin{itemize}
    ...
    \end{align*}
       % Então, para fins de comparação, consideramos quatro
...
%     de \emph{bremsstrahlung} eletrostático;
%     \vspace{0.3cm}
%     \pause
...
\begin{frame}
  ...
  \begin{figure}
    \centering
    \includegraphics[width=0.6\textwidth]{fig2a}
...
\begin{frame}
  ...
  \begin{figure}
    \centering
    \includegraphics[width=0.6\textwidth]{fig2b}
...
%\section*{Estado estacionário das ondas $L$ no novo formalismo}
\begin{frame}[noframenumbering]
