...
Beyond this limit, the solar wind still has a significant influence on
...
physics can be summarized as to understand the history, evolution, and
physical processes of the most influential object in the space environment
around our home planet and its interaction with the solar system and the
interstellar medium. 
...
\begin{figure}[h]
  \begin{center}
    \includegraphics[width=0.9\textwidth]{corona2017.png}
