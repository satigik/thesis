...
interstellar medium. This comet-shaped plasma bubble \cite{Dialynas2017}, has
an inner boundary, the \emph{termination shock}, which delimits the sphere
...
Inside the heliosphere, the solar and space physics research aims to understand
the history, evolution and dynamics of the Sun and its effects on Earth's space
environment. Besides that, the interplanetary system provide an accessible 

subjected to direct and relatively close action of
the solar wind and radiation, lies our planet, Earth. 

The energy the Sun
dumps over the Earth, in the form of visible light, ultraviolet and X-ray
radiation, not only determines the temperature, shape of the terrestrial
upper atmosphere and ionosphere, but also is responsible for the life as
we know it. 
