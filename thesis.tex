...
At a first glance, the study of plasmas seems completely unrelated
with

\begin{figure}[h]
  \begin{center}
    \includegraphics[width=0.5\textwidth]{corona2017.png}
%    \includegraphics[0.4\textwidth]{}
    \caption{Solar corona captured during the total solar eclipse of 2017. Credit:
      \href{https://hdr-astrophotography.com/a-propos/}{Nicolas Lefaudeux}.}
    \label{fig1}
  \end{center}
\end{figure}
