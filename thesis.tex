...
\cite{may}. Therefore, the study of the physics of plasma processes is a
fundamental branch of astrophysics\cite{tsypa}.
...
our theoretical results with phenomena observed in a naturally occurring space
plasma, that is also accessible to direct measurements. In that sense, the solar
plasma was the logical choice.
...
% \footnote{In the literature, the term ``astrophysical plasma'' is sometimes
...
accessible
to both in situ measurements and highly resolved remote sensing. 


 In this appendix, we will make a brief revision on solar
physics, pointing out the phenomena that are associated with our model. 
...
% \section{Kinetic processes in astrophysical plasmas}
% \label{sec:astro-plasma}
