...
physics work towards developing a better understanding of the Sun and
the solar processes molding this vast and complex dynamic system called
heliosphere; where, within, very close to its most influential object,
lies our home planet - Earth.

\subsection{Solar and space physics research}
\label{sec:topics}
Inside the heliosphere, the 
% As discussed before, the influence of the plasma ejected from the Sun
% goes way beyond the limits of our solar system. Under that perspective,
% Earth, the third planet, might be considered a very close neighbour of
% the Sun, being strongly affected by its .
