...
%%% I still have to list the last two appendixes in introduction
...
is reintroduced \cite{YZKS16}. This procedure results in the nonlinear
...
form of braking radiation was then called \emph{electrostatic bremsstrahlung}
...
wave equation. It is worth to mention again, that a more detailed procedure
of the inclusion of the noneigenmode contribution in the weak turbulence's
...
Such theory is the basis of the present research, whose primary objective
...
\label{cha:final}
In this thesis, we have presented the results of the first analysis of a new
...
indicates the action of a fundamental physical process; this process may
be the electrostatic bremsstrahlung. For instance, the possibility of the
formation of suprathermal electron velocity distributions in a mildly
collisional environment, as demonstrated in \cite{Tigik2017a}, has a positive
correlation with the velocity filtration model, which rely on the existence
of a high energy electron population in the transition region, located between
the chromosphere and the solar corona, to explain the temperature inversion
observed in the solar corona \cite{Scudder92a,Scudder92b,Anderson94,Scudder94,
  Scudder96,DS99,DS03,Teles15}.

As a final remark, we would like to emphasize the fundamental aspect of the
theory presented in Ref. \cite{YZKS16}. The rigorous analysis performed during
this doctoral research, suggest that collisional interactions involving charged
...
in space plasmas. On that regard...


% It is time for new advances in the kinetic description of plasmas. For
% a long time, space observations could only resolve physical phenomena occurring
% in macroscopic scales, described by the magnetohydrodynamic (MHD) theory.  

% A better understanding of the combined action of collective and collisional
% plasma processes has some important impact on how observational data from
% denser regions of the solar corona are analyzed. Now that the Parker solar
% probe 
...
\chapter{Two-dimensional time evolution of beam-plasma instability in the
  presence of binary collisions}
\label{master}
Results of the Master's dissertation that led to the current doctoral
research.
