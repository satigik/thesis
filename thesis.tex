...
\section{Collective and collisional processes in plasmas}
\label{sec:collec-coll-proc}
...
distant regions of the system. This nonlocal feature of the plasma
dynamics is called \emph{collective behavior} \cite{chen}.

Collective processes are the outcome of collective behavior, i.e.,
are processes that occur as a response of the collective behavior
of the plasma. Such phenomena exists in both neutral (same number of
negative and positive components), and nonneutral (different quantities
of negative and positive charges, or have only one charge species)
plasmas. The dynamics in both cases, however, is dramatically different.
In this work we are interested only in the first case and, once we
