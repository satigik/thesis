...
current state-of-the-art of solar and space physics research, followed
by a discussion on the solar plasma phenomena related to our study.
...
\begin{figure}[h]
  \begin{center}
    \includegraphics[width=0.89\textwidth]{solar_system_env.png}
...
Both websites were accessed at 11/08/2019.} (see Figures \ref{nasa} and \ref{esa}
) on understanding the complex physics of the Sun and interplanetary space
is to unlock means of predicting the occurrence and intensity of solar activity,
and anticipate how the near-Earth environment will be affected.  On that regard,
a critical aspect being addressed is the response of Earth’s magnetosphere,
ionosphere, and atmosphere to solar inputs. The objective is to open the
possibility of developing reliable models for the space weather forecast.
Forecasting space weather may help us to protect humans and electronic equipment
in space from the incoming flux of energetic ionized matter and radiation coming
from the Sun, and ground-based technological infrastructure from the geomagnetic
storms they cause \cite{NAP13060}.
\begin{figure}[h]
  \begin{center}
    \includegraphics[width=0.89\textwidth]{hso_fleet_chart_april_2019.pdf}
...
\begin{figure}[h]
  \begin{center}
    \includegraphics[width=0.89\textwidth]{ESA_s_fleet_of_Solar_System_explorers_2019.jpg}
...
Another important aspect... blah blah blah whiskas sachet... solar corona.
Talk about my work then corro pra galera 
...
\begin{figure}[h]
  \begin{center}
    \includegraphics[width=0.89\textwidth]{corona2017.png}
