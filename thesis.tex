...
century. The correct hypothesis (coronal mass ejections associated with
solar flares), however, which depended on advances in plasma physics
theory, came along only in $1929$ \cite{chapman1929cosmical,Koskinen2011}.

A better comprehension of the Sun and the dynamic space around our planet
goes beyond the pure scientific curiosity. It is true that this accessible
space physics laboratory can lead to discoveries that can be applied and
extended to remote cosmic systems. But the primary reason behind the
international effort (see Figures \ref{nasa} and \ref{esa}) on understanding
the complex physics of the Sun and the interplanetary space, is to enable
means to predict the occurrence and intensity of solar activity. This may
open the possibility of developing reliable space-weather forecasts that
may help us to protect satellites, humans  
