...
charged particles have quite a distinct behavior? Assuming the gravitational
force is negligible, the neutral particles will move freely in the medium
until one collides with another \cite{chen}. Thus, the interaction between
the neutral components is characterized as short-ranged, since it relies
only on binary collisions.
