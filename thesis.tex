...
This tenuous and rapid flowing plasma is the solar wind. It enfolds the Earth
as it travels outward the solar system, creating a region around the Sun that
extends to approximately $140\unit{AU}$ in the surrounding galactic space.
This region, called heliosphere, is the domain of solar and space physics. In
the boundaries of the heliosphere, the outward pressure of the solar plasma
balances the inward pressure from the interstellar medium. This interface
region, the heliopause, limits the volume in the galactic environment that is
under the influence of the solar wind \cite{NAP13060}. A general depiction of
the heliosphere and its main boundaries is depicted in \autoref{figD1}, where
the termination shock separates the inner and outer regions of the heliosphere.

\begin{figure}[h]
  \begin{center}
    \includegraphics[width=0.48\textwidth]{Heliosphere_main_Boundaries}
    \caption{Main boundaries of the heliosphere.
      {\footnotesize Credit:}
      \href{https://science.nasa.gov/heliophysics/focus-areas/heliosphere}
      {\footnotesize NASA}{\footnotesize , accessed at 07/08/2019}.}
    \label{figD1}
  \end{center}
\end{figure}
