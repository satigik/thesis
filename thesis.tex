...
of the current research in solar and space physics, and in \autoref{res}
we discuss how our work is related to what is pointed in the previous
section.
...
In \autoref{figD1}, we have a depiction of the regions and boundaries
...
effort\footnote{A complete description, of NASA's missions is available at
\url{https://science.nasa.gov/missions-page?field_division_tid=5&field_phase_tid=All}.
For ESA's missions, go to \url{http://sci.esa.int/home/51459-missions/}.
Both websites were accessed at 11/08/2019.} (see Figures \ref{nasa} and
...
energetic radiation emitted by solar flares. Extreme coronal mass ejections
...
\section{How all of this is related to our research?}
\label{res}
The work 
...
In \cite{Tigik2017a} ...
present a new fundamental mechanism that is capable
the formation of suprathermal tails in the electron velocity distribution function 

proposing a fundamental mechanism,
the electrostatic bremsstrahlung, that might take electrons out of the thermal
equilibrium


In \cite{Tigik2016a} we show for the first time that binary collisions
impacts the dynamics of the plasma-beam instability in the same timescale
of nonlinear processes associated to the emission and amplification of
electrostatic, high-frequency plasma waves associated to electrons, also
called .  
