...
\section{How all of this is related to this work?}
\label{sec:corona}
The source of the tenuous magnetized plasma permeating the heliosphere,
and also the origin of the dangerous solar output disturbing the near-Earth
environment, is the outermost layer of the Sun: the solar corona. The solar
corona can be easily recognized as the bright halo that appears around the
hidden Sun during solar eclipses. \autoref{corona} shows a beautiful
photograph of the corona, taken in the $2017$’s solar eclipse. In the picture,
one can see the moon covering the bright chromosphere, allowing us to have
a glimpse of the thin, but ultra-hot coronal plasma.
