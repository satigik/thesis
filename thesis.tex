...
different solar eclipses, August 21 $2017$ and $2019$. In both pictures, one
can see the moon covering the bright photosphere, allowing us to have a
glimpse of the thin, but ultra-hot coronal plasma. Non-intuitively, the solar
corona is, at the same time, the thinnest and the hottest outer layer of
the Sun, where the temperature is of the order of $10^6\unit{K}$.  
...
\begin{figure}[hb]
  \begin{center}
    ...
    \caption{Solar corona captured during the total solar eclipse of 2017 (top panel)
      ...
      penetrate the coronal region \cite{BenzA2002,Habbal2010,JeanVlaude2015}.
      {\footnotesize Credit:}
