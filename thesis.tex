...
% Astrophysics is a millennial observational science, that started with bare eyes
% observation of the sky, describing the constellations, and solar, lunar and
% planetary cycles. These first observations of the relative motion of planetary
% bodies led to solar clocks, calendars, and navigation charts. Nowadays, we have
% extremely sophisticated equipment of observation, both on Earth and in space,
% that can reach
...
% In order to understand what collective processes are, one has to
% have in mind that a plasma is a many-body system composed mostly
% - or completely - of charged particles, that interact with each
% other through electromagnetic forces. Due to the long range nature
% of the electromagnetic forces, one charge can interact with several
% charges at the same time, that will interact with others, and so
% on. In such arrangement, the particle motion, at a certain volume
% element of the plasma, will be affected not only by the surrounding
% environment, but it will also be influenced by the conditions at
% distant regions of the system. This nonlocal characteristic  of the plasma
% dynamics is called \emph{collective behavior} \cite{chen}.
