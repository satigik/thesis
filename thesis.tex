...
heliosheath. In this region, the solar wind particles start being subjected to
increasing external pressure, transitioning to a subsonic, turbulent flow that
...
The extension of the influence that the plasma ejected from the Sun has, puts
in perspective the fundamental role played by plasma physics in the solar and
space physics research. %% talk about some key processes
