...
Astrophysical plasmas\footnote{In the literature, the term ``astrophysical
  ...
  synonyms.} are observed in a vast range of densities, temperatures, magnetic
fields, ionization degree, and scale lengths\footnote{A comprehensive
  description of the scales and characteristics of cosmic plasmas can be seen
  in Section 1.2 of Ref. \cite{peratt2014}.}. Starting in the outer layers of
...
in the universe is in the plasma state. Under cosmic conditions, even the weakly
ionized gas of the neutral hydrogen regions around galaxies or in the atmosphere
of cold stars have a strong reaction to electromagnetic fields, exhibiting the
characteristic collective behavior of plasmas and, therefore, are also considered
plasmas\cite{tsypa,may,peratt2014}. 

Since the pervasiveness of the plasma state in space came as a fact, plasma
physics became an essential component in the multidisciplinary framework of
astrophysics \cite{Parker1958a,Alfven1961,Gailitis1964}. At the same time,
observations of space plasma phenomena have been gaining increasing relevance
in the progress of theoretical, computational, and experimental plasma physics
research. The quality and quantity of space observations led to the development
of new theoretical models, and more advanced numerical schemes and experimental
set-ups in the area of plasma physics \cite{YZKS16,Donnert2014,Pezzi2018,
  Howes2018,Peterson2019}.


A recent example
of this complementarity is presented in Ref. \cite{Peterson2019}, where the
authors reproduced in the laboratory a magnetic structure called \emph{Parker spiral}, which is
related to the acceleration process of solar - and stellar - winds. The
authors compare their results with numerical simulation of the same
structure, since in situ observations of this particular phenomena are not
available yet. In Ref. \cite{Chen2019}, we have the opposite situation. 


 
% Since the ubiquity of plasmas in space came as a fact, astrophysicists and
% plasma physicists have been noticing an increasing necessity for exchanging
% knowledge and mutually collaborating with their results. A particular field
% of research that has been acting for a long time as a bridge between these two
% areas is the solar physics. The accessibility of the solar plasma to direct,
% in situ measurements, highly resolved remote sensing and high-resolution
% spectroscopy turned the solar system into Earth's space physics laboratory.
...
Solar physics can be thought of as a combination of plasma and space physics.
The wide variety of plasmas and the accessibility to direct, in situ measurements,
highly resolved remote sensing and high-resolution spectroscopy turned the solar
system into Earth's plasma physics laboratory in space.
%% falar sobre como física sola pode contribuir para fśica de plasmas em geral
