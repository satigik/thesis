...
The plasma, as a collection of ions and electrons, has its dynamics
dominated by the electric and magnetic fields generated by the presence
of charged particles, and electric currents that arise from their
movement. Due to the long-range nature of these self-generated fields,
one particle affects the movement of several other particles, which
will interact with other particles, and so on. This \emph{collective
  behavior}\footnote{A more detailed description on all the processes
  and conditions that characterize the collective behavior in neutral
  plasmas can be seen in Refs. \cite{bitt,gurnett2017,chen}. For
  nonneutral plasmas, see Ref. \cite{DavidsonNonNeutral}.} is what
characterizes an ionized gas as a plasma, and also is the reason behind
the complexity of the plasma dynamics.
