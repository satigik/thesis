...
variation of the velocity distribution function due to collisional interactions
between the system's particles.

For plasmas, in the general case, the acting force in Eq. \eqref{boltz}, is
given by the Lorentz force added by an external force, which, at kinetic scales,
...
\begin{equation}
  ...
  \label{florentz}
\end{equation}
where $q_{\alpha}$ is the charge of the particles of kind $\alpha$, $c$ is
the speed of light, and ${\bf E}({\bf r},t)$ and ${\bf B}({\bf r},t)$ are
the electric and magnetic fields, respectively.

Collisional interactions can be neglected when the time necessary for
the plasma to establish statistical equilibrium - the relaxation time
$\tau_{\rm rel}$ - is much greater than the characteristic time $\tau$
of the process being studied~\cite{klimon,Tigik2015}.
...
\section{Vlasov-Maxwell system of equations}
