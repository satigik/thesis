...
system, a complex set of coupled equations which solution invariably will
...
shape slowly modifies the wave spectrum, which new form will then
...
results and presents a brief discussion on the and perspectives of this
...
which solutions are the wave dispersion relations.
...
Such theory is the basis of the present research, which primary objective
...
which is the case of Langmuir oscillations, but the same does not apply
to ion-sound waves. Moreover, the results for ion-sound waves are quite
well behaved with the original approximation, which is the same that was
initially used for  $L$ waves. Therefore, $S$ waves will take part only in
\Cref{sec:orig-appr}, while \Cref{sec:alt-approx} will be directed solely
the $L$ waves expression.
...
The work in question, which title
