...
other planetary bodies and the interstellar medium. % In the list below we
% highlight the most Ref. \cite{schrijver2009}. 
% are listed below:
\begin{itemize}
...
\begin{figure}[h]
  \begin{center}
    \includegraphics[width=0.9\textwidth]{hso_fleet_chart_april_2019.pdf}
...
\begin{figure}[h]
  \begin{center}
    \includegraphics[width=0.9\textwidth]{ESA_s_fleet_of_Solar_System_explorers_2019.jpg}
  ...
  \end{center}
\end{figure}
% As described above, ionized particles ejected by the Sun determine the
% overall dynamics of the interplanetary medium until the termination shock
% boundary. Beyond this limit, the solar wind still has a significant
% influence on the nature of the local interstellar space for a long distance
% up to the heliopause.
% As a well established scientific discipline, solar and space physics work
% towards developing a better comprehension of the Sun and
% the solar processes molding this vast and complex dynamic system called
% heliosphere. 



% ; where, within, very close to its most influential object,
% lies our home planet - Earth.
