...
very close to each other. A fully ionized gas, on the other hand, is only
composed of charged particles, that are sources of electric fields. Besides
that, the motion of charged particles generates electric currents, that
will induce magnetic fields. This means that one charge can interact with
several other charges at a considerable distance, through these fields.
Therefore, a partially ionized gas is considered a plasma when its dynamics
is dominated by the electric and magnetic forces of the charged particles,
consequently, a fully ionized gas is also a plasma.


Astrophysical plasmas are observed in a myriad of configurations,
regarding composition, density, temperature, and degree of ionization.
