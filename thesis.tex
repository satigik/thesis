...
knowledge and mutually collaborating with their results. In this arrangement,
plasma physics provides theoretical, computational, and laboratory models
that might help with the interpretation and propose a physical explanation
for astrophysical observations. Astrophysics, on the other hand, contributes
with data from observations of phenomena that are unique to cosmic plasma and
might be used to confirm theoretical and computational predictions on plasma
physics, and also to compare with experimental results\cite{tsypa,Kulsrud2005}.
A particular field of research that has been acting for a long time as a bridge
between these two areas is the solar physics. 
