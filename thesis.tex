...
magnetic fields, and scale lengths\footnote{For a relatively brief, but
  comprehensive, description of the scales and characteristics of cosmic plasmas,
  see Section 1.2 of Ref. \cite{peratt2014}.}. Starting in the outer layers of
...
in the universe is in the plasma state\cite{may}. The absolute majority of space
plasmas are unreachable to in situ observation, being accessible only through
analysis of the electromagnetic spectrum emitted from their remote location. 


% The accessibility to
% direct, in situ measurements, highly resolved remote sensing and high-resolution
% spectroscopy make of the solar plasma the right choice for our analysis.
