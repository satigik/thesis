...
\chapter{Kinetic theory and astrophysical plasmas}
\label{sec:kin-theo}
...
\footnote{A detailed description of all the processes and conditions that
...
electric and magnetic fields, in a time instant. This strategy is not practical
and in most of the cases not feasible for many-body systems, like the plasma.  
However, this microscopic description can be dealt through a hierarchy of
