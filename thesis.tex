...
authors also compare their results with numerical simulation of the same
structure. Astrophysics, on the other hand, contributes with data from
observations of space plasma phenomena that might be useful for testing
theoretical predictions, and comparing with numerical and experimental
results. In Ref. \cite{Chen2019}, for instance, 
