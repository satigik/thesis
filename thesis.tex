...
charged particles have quite a distinct behavior? Assuming that the
gravitational force is negligible, the neutral particles will move freely
in the medium until one collides with another \cite{klimon}. Therefore, the
interaction between the neutral components is characterized as short-ranged,
since it relies only on collisions between two particles. Charged particles,
on the other hand, are sources of electric fields. Besides that, their
motion generates currents that will induce magnetic fields. The
