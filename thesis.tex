...
%which 
% LFZ190822: Posso estar enganado, mas me parece que aqui seria mesmo
% "whose", como estava antes, e não "which".
% Sabrina: resolvi colocar "whose" de novo depois de uma rápida, mas
% controversa, pesquisa no google
...
% LFZ190822: Não seria mesmo "whose"?
% Sabrina: ok
...
neutral. In such case, the density of protons and electrons per volume unity
is the same, therefore $n_e=n_i=n$.
...
the plasma density and $e$ the charge. This means that a specific charge
...
significant excess - of one kind of charge~\cite{DavidsonNonNeutral}. In this
work, it will be considered a fully ionized hydrogen plasma, which is overall
neutral, with the density of protons and electrons being the same, therefore
$n_e=n_i=n$.
